                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-1 opacity-80 group-hover:opacity-100 transition-opacity">
                    ...
                    <button
                      onClick={async (e) => {
                        ...
                        try {
                          ...
                          if (result.skipped > 0) {
                            mensaje += `\nSaltados (ya enviados): ${result.skipped}`;
                          }
                          alert(mensaje);
                    ...
                    <button
                      onClick={async (e) => {
                        e.stopPropagation();
                        const confirmar = window.confirm(`¿Estás seguro de que quieres eliminar el evento "${eventTitle}"? Esta acción no se puede deshacer.`);
                        if (confirmar) {
                          try {
