        ...
        <div style={styles.mainCard}>
          ...
          <div style={styles.formSection}>
            ...
            <p style={styles.registerText}>
              ¿Ya tienes una cuenta? <Link to="/login" style={styles.registerLink}>Haz clic aquí</Link>.
            </p>
...
const styles = {
  ...
  logoCard: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: '#2B2738' // Match main card bg or keep transparent/slightly lighter
  },

  logoSquare: {
    width: '450px', // Slightly larger based on visual
    height: '550px', // Taller as per reference
    borderRadius: '24px',
    position: 'relative',
    overflow: 'hidden',
  ...
  fullBackground: {
    ...
    left: 0,
    zIndex: 1,
    filter: 'brightness(0.8)' // Darken background slightly for text contrast
  },
  ...
  formSection: {
    flex: 1,
    padding: '60px 60px 40px 40px', // Adjusted padding
    backgroundColor: '#2B2738',
    display: 'flex',
    flexDirection: 'column',
    justifyContent: 'center'
